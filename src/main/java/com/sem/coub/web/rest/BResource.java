...
/**
 * REST controller for managing {@link com.sem.coub.domain.B}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BResource {
    ...
    private static final String ENTITY_NAME = "coubB";
     ...
     */
    @PostMapping("/bs")
    public ResponseEntity<B> createB(@Valid @RequestBody B b) throws URISyntaxException {
     ...
     */
    @PutMapping("/bs/{id}")
    public ResponseEntity<B> updateB(@PathVariable(value = "id", required = false) final UUID id, @Valid @RequestBody B b)
    ...
    public ResponseEntity<B> partialUpdateB(@PathVariable(value = "id", required = false) final UUID id, @NotNull @RequestBody B b)
        throws URISyntaxException {
        ...
        Optional<B> result = bRepository
            ...
            .map(existingB -> {
                if (b.getGroup() != null) {
                    existingB.setGroup(b.getGroup());
                }
                if (b.getStartSate() != null) {
                    existingB.setStartSate(b.getStartSate());
                }
     ...
     */
    @GetMapping("/bs/{id}")
    public ResponseEntity<B> getB(@PathVariable UUID id) {
     ...
     */
    @DeleteMapping("/bs/{id}")
    public ResponseEntity<Void> deleteB(@PathVariable UUID id) {
